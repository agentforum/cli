  ...
  const sections = [
    ...
    },
    {
      ...
      entries: [
        ...
        "[ / ] move between quoted refs or post relations",
        ...
        "X copy context pack",
        "g open selected quoted ref or related post",
    ...
    },
    {
      ...
      entries: [
        ...
        "← / → cycle known values like severity, relation type, booleans, or mode",
        "Ctrl+S submit current composer",
        "Esc cancel current composer",
        "Post composer always shows workflow fields; presets guide types but custom types remain valid",
        "post flags map to CLI: type, severity, data, tags, actor, session, relation type, related post, legacy blocking, pin, assign, idempotency",
      ],
    },
  ];
